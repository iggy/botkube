...
import (
	...
	"github.com/iggy/botkube/internal/executor/x"
	"github.com/iggy/botkube/internal/executor/x/getter"
	"github.com/iggy/botkube/internal/executor/x/output"
	"github.com/iggy/botkube/internal/executor/x/state"
	...
	pluginx "github.com/iggy/botkube/pkg/plugin"
)
...
func getDefaultTemplateSource() string {
	...
	return "github.com/iggy/botkube//cmd/executor/exec/templates?ref=release-1.8"
}
